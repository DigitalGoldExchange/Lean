...
namespace QuantConnect.Algorithm
{
    public partial class QCAlgorithm
    {
        ...
        private readonly List<Universe> _pendingUnivereAdditions = new List<Universe>();
        ...
        {
            if (_pendingUnivereAdditions.Count + _pendingUserDefinedUniverseSecurityAdditions.Count == 0)
            {
